...
public class ResponseOneDay {
    ...
    public ResponseOneDay(int anInt, String string, String resultSetString, String setString, double aDouble) {
    }

    public ResponseOneDay(String string, String resultSetString, String setString, double aDouble) {
    }

    public ResponseOneDay() {
    }
